...
Строковые константы сохраняются в область памяти переменных виде указателя на ячейку с длиной

А также в область памяти строк в виде ячейки с длиной и последовательности ячеек символов 
...
- При загрузке в память команды MEM заменяются на значение их аргумента
